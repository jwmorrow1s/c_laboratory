...
static void *
standard_allocator_alloc (Allocator *self, size_t size)
{
  (void)self;
  return malloc (size);
}
...
static void
standard_allocator_free (Allocator *self, void *bytes)
{
  (void)self;
  free (bytes);
}
...
static void *
static_allocator_alloc (Allocator *self, size_t size)
{
...
/** noop */
static void
static_allocator_free (Allocator *self, void *bytes)
{
  (void)self;
  (void)bytes;
}

static ArenaAllocatorContext *
arena_context_create (size_t arena_size)
{
...
static void *
arena_allocator_alloc (Allocator *self, size_t size)
{
  /** TODOs
...
/** noop */
static void
arena_allocator_free (Allocator *self, void *bytes)
{
  (void)self;
  (void)bytes;
}
...
static void
static_allocator_context_init (StaticAllocatorContext *context,
...
void
standard_allocator_init (Allocator *self)
{
  self->context = NULL;
...
void
standard_allocator_deinit (Allocator *self)
{
  (void)self;
}

void
static_allocator_init (Allocator *self, StaticAllocatorContext *context,
                       size_t initial_size, void *data)
{
...
void
static_allocator_deinit (Allocator *self)
{
  static_allocator_context_init (self->context, 0, NULL);
}

void
arena_allocator_init (Allocator *self, size_t arena_size)
{
...
void
arena_allocator_deinit (Allocator *self)
{
