...
{
	StaticAllocatorContext* context = 
		(StaticAllocatorContext*) self->context;
...
arena_allocator_alloc(Allocator* self, size_t size)
{
	 ...
	 */
	ArenaAllocatorContext* context = 
		(ArenaAllocatorContext*) self->context;
